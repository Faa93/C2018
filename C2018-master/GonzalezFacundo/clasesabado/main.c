...
//Trabajo practico
//TRABAJAR LA CALCULADORA CON FLOTANTES, EL FACTOREAL SE HACE CON NUMEROS ENTEROS, EL RESULTADO DEBEMOS TRABAJARLO COMO ENTENRO.
//SE PUEDE TRABAJAR CON ENTEROS.
